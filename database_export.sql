...
--
-- Table structure for table `drankjes`
--
...
--
-- Dumping data for table `drankjes`
--
...
(41, 'Cheese Burger', 12.50, 'Een burger met extra kaas', '🍔'),
...
(53, 'Appeltaart', 3.99, 'Warm stuk appeltaart met kaneel', '🥧'),
(54, 'Mozzarella Sticks', 6.99, 'Krokante gefrituurde mozzarella sticks met marinara saus', '🧀'),
(55, 'Mac & Cheese Hapjes', 6.50, 'Gefrituurde romige mac en kaas hapjes', '🧀');
...
--
-- AUTO_INCREMENT for table `drankjes`
--
ALTER TABLE `drankjes`
